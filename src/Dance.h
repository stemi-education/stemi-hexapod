...
#ifndef FULL_DANCE
#define NUMBER_OF_MOVES 48
#else
#define NUMBER_OF_MOVES 460
#endif // FULL_DANCE
...
public:
	...
	{
		//solo
		PF,	PF,  PF,	PF,	0,	PR,	0,PL,			PL,	PR,  PL,	PR,	PL,	PR,	PL,	PR,		0,	PR,	0,	PL,	0,	PR,	0,	PL,			PL,	PR,  PL,	PR,	PL,	PR,	PL,	PR,
		PL,	PL,  PL,	PL,	PR,	PR,	PR,	PR,		PL,	PL,  PL,	PL,	PR,	PR,	PR,	PR
	};
...
uint8_t ledAnimationArray[460] =
{
	...
	{
		{ { 0,0,0 },				{ 0,0,0 },			0, 50}, //C0
		{ { 255,0,0 },			{ 0,0,0 },			0, 50 }, //CR
		{ { 0,255,0 },			{ 0,0,0 },			0, 50 }, //CG
		{ { 0,0,255 },			{ 0,0,0 },			0, 50 }, //CB
		{ { 255,242,0},			{ 0,0,0 },			0, 50 }, //CY
		{ { 0,255,255 },		{ 0,0,0 },			0, 50 }, //CC
		{ { 0,255,255 },		{ 0,0,0 },			0, 50 }, //CP
	};
